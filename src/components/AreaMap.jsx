...
export const SPOTS = [
  ...
  },
  {
    ...
    drive: "1 mi · 4 min",
    walk: "20 min",
    blurb: "A historic inn at the top of the lane into Polperro — the nearest pub to the holiday park, with a mill wheel and low beams.",
  },
  {
    id: "village-store",
    name: "Polperro village stores",
    category: "Nearest shop",
    coords: [50.3310, -4.5200],
    drive: "1.5 mi · 5 min",
    walk: "25 min",
    blurb: "The nearest shop for basics and newspapers — a short walk down into the village.",
  },
];
