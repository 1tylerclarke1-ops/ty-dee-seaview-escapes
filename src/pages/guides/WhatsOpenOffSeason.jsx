...
export default function WhatsOpenOffSeason() {
  return (
    ...
    >
      ...
      <ul>
        <li><strong>The Three Pilchards</strong> and <strong>The Ship Inn</strong> — open through winter, reduced days. Check before you plan a meal.</li>
        <li><strong>Polperro village shops</strong> — a small general store keeps short winter hours; don't rely on it for a big shop.</li>
        <li><strong>The harbour and beach</strong> — always open, always free, and at their best when it's quiet.</li>
      </ul>

      <h2>Looe — ten minutes away, fully open</h2>
      <p>
      ...
      <p>
        <strong>Falmouth, Truro and Plymouth</strong> are all within an hour and fully open in winter — good
